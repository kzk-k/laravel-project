<header x-data="{ open: false }"
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <!-- Logo -->
            <a href="{{ route('admin.home.create') }}" class="flex items-center shrink-0">
            ...
            <div :class="{ 'absolute left-0': open, 'relative': !open }"
                ...
                @php
                    $navLinks = ['Image list' => '/imagelist', 'Learn More' => '/learn'];
                @endphp
                <!-- Navigation Links -->
                <nav :class="{
                ...
                <div class="flex items-center">
                    ...
                    <div x-data="{ dropdownOpen: false }"
                        ...
                        <button @click="dropdownOpen=!dropdownOpen"
                            class="inline-flex items-center justify-between w-full sm:px-3.5 sm:py-2 py-2.5 px-4 text-sm font-medium text-gray-500 transition duration-0 bg-white border-transparent sm:border rounded-full hover:bg-slate-200/50 dark:text-white/70  hover:text-gray-700 focus:outline-none">
